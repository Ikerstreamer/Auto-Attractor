...
function Loop() {
    ...
    if(document.getElementById("Pscope").checked) document.getElementById("console").innerHTML = player[document.getElementById("cInput").value];
    else document.getElementById("console").innerHTML = window[document.getElementById("cInput").value];
}
